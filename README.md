...
Thus, we can use [Radio Notifications](https://developer.nordicsemi.com/nRF_Connect_SDK/doc/latest/nrfxlib/mpsl/doc/radio_notification.html)) to toggle a pin in a lightweight IRQ on either edge. This lets us paint a clear picture of when the notification actually started and stop described above!
